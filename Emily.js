...
const { ngazap } = require('./penyimpanan/virtex/ngazap')
const { buttonkal } = require('./penyimpanan/virtex/buttonkal')
const { cttl } = require('./penyimpanan/virtex/cttl')
const { tizi } = require('./penyimpanan/virtex/tizi')
const { weg } = require('./penyimpanan/virtex/weg')
const { virtex7 } = require('./penyimpanan/virtex/virtex7')
...
const thumbnail = fs.readFileSync ('./penyimpanan/image/Emily.jpg')
const thumb = fs.readFileSync ('./penyimpanan/image/Emily.jpg')
const kalimage = fs.readFileSync ('./penyimpanan/image/Emily.jpg')
...
const banned = JSON.parse(fs.readFileSync('./penyimpanan/dbnye/banned.json'))

virgam = fs.readFileSync(`./penyimpanan/image/deden.jpeg`)
//=================================================//
module.exports = emily = async (emily, m, chatUpdate, store) => {
 try {
...
const botNumber = await emily.decodeJid(emily.user.id)
const isCreator = [botNumber, ...owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
const sender = m.isGroup ? (m.key.participant ? m.key.participant : m.participant) : m.key.remoteJid
const groupMetadata = m.isGroup ? await emily.groupMetadata(from).catch(e => {}) : ''
...
const reply = (teks) => {
return emily.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/3e86f2c834ac0490a1231.jpg',"thumbnail": thumb,"sourceUrl": `https://wa.me/628595372305081?text=assalamualaikum+bang+RLP27`}}}, { quoted:m})} 
...
.on('finish', async () => {
await emily.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
.on('finish', async () => {
await emily.sendMessage(from, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
let { key } = await emily.sendMessage(from, {text: '...'})//Pengalih isu

for (let i = 0; i < hawemod.length; i++) {
/*await delay(10)*/
await emily.sendMessage(from, {text: hawemod[i], edit: key });//PESAN LEPAS
}
}
if (autodelete) {
emily.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: true,
...
let gclink = (`https://chat.whatsapp.com/`+await emily.groupInviteCode(m.chat))
let isLinkThisGc = new RegExp(gclink, 'i')
let isgclink = isLinkThisGc.test(m.text)
if (isgclink) return emily.sendMessage(m.chat, {text: `\`\`\` Group Link Terdeteksi \`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return emily.sendMessage(m.chat, {text: `\`\`\` Group Link Terdeteksi \`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isCreator) return emily.sendMessage(m.chat, {text: `\`\`\` Group Link Terdeteksi \`\`\`\n\Owner telah mengirim link, owner bebas memposting link apa pun`})
await emily.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: false,
...
/*emily.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
emily.sendMessage(from, {text:`\`\`\` Wa.me Link Terdeteksi \`\`\`\n\n@${kice.split("@")[0]} Jangan kirim wa.me link di group ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
//antivirtex by geekz
  if (AntiVirtex) {
  if (budy.length > 3500) {
...
await /*emily.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
emily.sendMessage(from, {text:`\`\`\` Bad Word Terdeteksi \`\`\`\n\n${pushname} Jangan menggunakan kata-kata buruk di grup ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})}
}
//antiasing by geekz
...
await emily.groupParticipantsUpdate(m.chat, [member[i]], "remove")
await sleep(1000)
}
}
}
...
userJid: emily.user.id,
quoted : m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, emily.user.id)
...
emily.ev.emit('messages.upsert', msg)
}
//=================================================//
if (budy.startsWith('')) {
try {
...
async function sendGeekzMessage(chatId, message, options = {}){
    ...
    return await emily.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}

const sendapk = (teks) => {
emily.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
m.reply('*Maaf Salah!! Yang Bener Contoh : Yoapk EMILY*')
}
...
//=================================================//
const sendzip = (teks) => {
emily.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
m.reply('*Salah senpai!! Yang Bener Contoh : Yozip Emily*')
}
...
//=================================================//
const senddocu = (teks) => {
emily.sendMessage(from, { document: teks, mimetype: 'application/pdf'}, {quoted:m})
m.reply('*Maaf Salah!! Yang Bener Contoh : Yopdf EMILY*')
}
...
const sendvn = (teks) => {
emily.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, {quoted:m})
}
...
try {
ppuser = await emily.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
emily.sendText(from, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+from].pesan = mesg }).catch(_ => _)
...
if (budy.toLowerCase() == jawaban) {
   emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Tebak Lagu \n\nJawaban Benar \n\nIngin bermain lagi? Silahkan Ketik Tebak Lagu`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Tebak Gambar \n\nJawaban Benar \n\nIngin bermain lagi? Silahkan Ketik Tebak Gambar`}, {quoted:m})
...
if (budy.toLowerCase() == jawaban) {
 emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Tebak Kata \n\nJawaban Benar \n\nIngin bermain lagi? Silahkan Ketik Tebak Kata`}, {quoted:m})  
...
if (budy.toLowerCase() == jawaban) {
 emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Tebak Lontong \n\nJawaban Benar \n\nIngin bermain lagi? Silahkan Ketik Tebak Lontong`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Tebak Kalimat \n\nJawaban Benar \n\nIngin bermain lagi? Silahkan Ketik Tebak Kalimat`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Tebak Lirik \n\nJawaban Benar \n\nIngin bermain lagi? Silahkan Ketik Tebak Lirik`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Tebak Tebakan \n\nJawaban Benar \n\nIngin bermain lagi? Silahkan Ketik Tebak Tebakan`}, {quoted:m}) 
...
if (room.x !== room.o) await emily.sendText(room.x, str, m, { mentions: parseMention(str) } )
await emily.sendText(room.o, str, m, { mentions: parseMention(str) } )
if (isTie || isWin) {
...
emily.sendTextWithMentions(from, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
emily.sendText(from, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) emily.sendText(roof.p, `Silahkan pilih \n\nBatu\nKertas\nGunting`, m)
if (!roof.pilih2) emily.sendText(roof.p2, `Silahkan pilih \n\nBatu\nKertas\nGunting`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) emily.sendText(from, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
emily.sendTextWithMentions(from, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
if (!roof.pilih2) emily.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) emily.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
emily.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
//=================================================//
case 'textmaker':
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
...
let metaDATA = await emily.groupMetadata(idgc).catch((e) => m.reply(e))
...
setTimeout(function() {
emily.sendMessage(getDATA[i], { text: pesan });
count--;
sentCount++;
if (count === 0) {
...
for (let geek of mem) {
await sleep(3000)
emily.sendMessage(geek, {text: `${teksnye}`}, {quoted:m})
}
...
case 'addprem':
if (!isCreator) return 
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 62895372305081`)
bnnd = text.split("|")[0].replace(/[^0-9]/g, '')
let ceknye = await emily.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
//=================================================//
case 'listprem':
if (isBan) return m.reply('*Kamu Kena Banned*')
 teksooo = '*List Premium*\n\n'
for (let i of owner) {
teksooo += `- ${i}\n`
}
teksooo += `\n*Total : ${owner.length}*`
emily.sendMessage(from, { text: teksooo.trim() }, 'extendedTextMessage', { quoted:m, contextInfo: { "mentionedJid": owner } })
break
//=================================================//
case 'pengguna':  {
if (!isCreator) return m.reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 62895372305081*`)
if (args[1]) {
...
case 'owner': case 'crator':{
 emily.sendContact(from, global.owner, hw)
}
break
//=================================================
...
emily.relayMessage(from, contact.message, { messageId: contact.key.id })
await sleep(2000)
emily.relayMessage(from, contact.message, { messageId: contact.key.id })
await sleep(2000)
emily.relayMessage(from, contact.message, { messageId: contact.key.id })
...
emily.relayMessage(from, product.message, { messageId: product.key.id })
emily.sendMessage(m.chat, { sticker : thumb }, { quoted:kalgans })
}
break
//=================================================
case '': case '': {
...
emily.sendMessage(m.chat, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(m.chat, { scheduledCallCreationMessage: { callType: "AUDIO", scheduledTimestampMs: 1200, title: cap}},{ messageId: scheduledCallCreationMessage })
await sleep(2000)
}
}
break
...
let Pe = await emily.groupAcceptInvite(result)
emily.sendMessage(Pe, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(Pe, { scheduledCallCreationMessage: { callType: "AUDIO", scheduledTimestampMs: 1200, title: cap}},{ messageId: scheduledCallCreationMessage })
await sleep(2000)
emily.sendMessage(Pe, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(Pe, { scheduledCallCreationMessage: { callType: "AUDIO", scheduledTimestampMs: 1200, title: cap}},{ messageId: scheduledCallCreationMessage })
...
await loading()
const cap = `${buttonkal}`
emily.sendMessage(from, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(from, { scheduledCallCreationMessage: { callType: "AUDIO", scheduledTimestampMs: 1200, title: cap}},{ messageId: scheduledCallCreationMessage })
await sleep(2000)
emily.sendMessage(from, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(from, { scheduledCallCreationMessage: { callType: "AUDIO", scheduledTimestampMs: 1200, title: cap}},{ messageId: scheduledCallCreationMessage })
...
emily.relayMessage(from, document.message, { messageId: document.key.id })
await sleep(2000)
emily.sendMessage(from, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(from, document.message, { messageId: document.key.id })
...
emily.relayMessage(Pe, document.message, { messageId: document.key.id })
await sleep(2000)
emily.sendMessage(Pe, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(Pe, document.message, { messageId: document.key.id })
...
"retailerId": "011",
"url": "https://wa.me/62895372305081",
"productImageCount": 500
},
"businessOwnerJid": "6285658186432@s.whatsapp.net"
}
}), { userJid: from, quoted:kalgans})
emily.relayMessage(Pe, product.message, { messageId: product.key.id })
await sleep(2000)
emily.sendMessage(Pe, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
emily.relayMessage(Pe, product.message, { messageId: product.key.id })
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
joauu = fs.readFileSync('./penyimpanan/video/hwmods.mp4')
emily.sendMessage(from, { video: joauu, mimetype: 'video/mp4', caption: `ANDROID 11 KEBAWAH AWAS NGELEG WMEHEHEHEHEH  ` }, {quoted:kalgans})
}
break
//=================================================//
case 'jomok': {
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
joauuuuu = fs.readFileSync('./penyimpanan/video/hwmods2.mp4')
emily.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `ANDROID 11 KEBAWAH AWAS NGELEG WMEHEHEHEHEH  ` }, {quoted:kalgans})
}
break
//=================================================//
case 'linkgroup': case 'linkgc': {
if (!isCreator) return m.reply('*khusus Premium*')
if (!m.isGroup) return m.reply('Maaf Perintah Ini Hanya Untuk Di Grup!')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
await loading()
let response = await emily.groupInviteCode(from)
emily.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'resetlinkgc':
...
let response = await emily.groupInviteCode(from)
emily.sendText(bnnd, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
...
if (!m.isGroup) return m.reply('Maaf Perintah Ini Hanya Untuk Di Grup!')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!isAdmins) return m.reply('Jadikan Bot Sebagai Admin Group!')
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await emily.groupParticipantsUpdate(from, [users], 'remove')
}
break
//=================================================//
case 'add': {
...
await emily.groupParticipantsUpdate(from, [users], 'add')
}
break
//=================================================//
case 'promote': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await emily.groupParticipantsUpdate(from, [users], 'promote')
}
break
//=================================================//
case 'demote': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await emily.groupParticipantsUpdate(from, [botNumber], 'demote')
}
break
//=================================================//
case 'hidetag': {
...
if (!m.isGroup) return m.reply('Maaf Perintah Ini Hanya Untuk Di Grup!')
await loading()
emily.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, {quoted:m})
}
break
//=================================================//
case 'ttp':
...
ini_txt = args.join(" ")
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=emilygans&text=${ini_txt}`)
emily.sendMessage(from, { sticker : ini_buffer }, { quoted:m })
break
//=================================================
case 'editgroup': {   
if (!isCreator) return m.reply('*khusus Premium*')
...
await loading()
if (args[0] === 'close'){
await emily.groupSettingUpdate(from, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
await emily.groupSettingUpdate(from, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
} else {
emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Group Open
...
await loading()
 if (args[0] === 'open'){
await emily.groupSettingUpdate(from, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else if (args[0] === 'close'){
await emily.groupSettingUpdate(from, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else {
 emily.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Editinfo Open
...
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
await emily.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'editsubjek': {
...
await loading()
await emily.groupUpdateSubject(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'editdesk':{
...
if (!text) throw 'Text Nya ?'
await loading()
await emily.groupUpdateDescription(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'tagall': {
...
emily.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted:m })
}
break
//=================================================//
case'demoteall':
...
if (!isAdmins) return m.reply('Jadikan Bot Sebagai Admin Group!')
await loading()
var groupe = await emily.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
mems.push(adm.id.replace('c.us', 's.whatsapp.net'))
})
emily.groupParticipantsUpdate(from, mems, 'demote')
break
//=================================================//
case'promoteall':
if (!isCreator) return m.reply('*Khusus Premium*')
...
emily.groupParticipantsUpdate(from, mems, 'promote')
break
//=================================================//
case 'tutorial': {
await loading()
...
await loading()
let cret = await emily.groupCreate(args.join(" "), [])
let response = await emily.groupInviteCode(cret.id)
emily.sendMessage(m.chat, { text: ` *Create Group Sewa* 
...
let encmedia = await emily.sendImageAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await emily.sendVideoAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
By ${botname}`
try {
pp = await emily.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
emily.sendFile(from, pp, "", m, { caption: tekse, mentions: await emily.parseMention(tekse) })
...
case 'hw': { 
if (isBan) return m.reply('*Kamu Kena Banned*')
joauuuuuuu = fs.readFileSync('./penyimpanan/video/hwmods2.mp4')
emily.sendMessage(m.chat, {video: joauuuuuuu, caption:`selamat datang`,viewOnce : true},{quoted:m })
}
break
//=================================================
case "welcome":
...
emily.sendMessage(from, {text: `Fitur Welcome Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
let getGroups = await emily.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
let anu = groups.map(v => v.id)
m.reply(`Mengirim Broadcast Ke ${anu.length} Group Chat, Waktu Selesai ${anu.length * 1.5} detik`)
for (let i of anu) {
await sleep(1500)
emily.sendMessage(i, {text: `${text}`}, {quoted:m})
    }
...
emily.sendMessage(from, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
await loading()
 if (!m.isGroup) return m.reply('Maaf Perintah Ini Hanya Untuk Di Grup!')
emily.sendMessage(from, { text : `Haii  Aku Shekai Bot   
...
if (isAdmins) return emily.sendMessage(m.chat, {text: `\`\`\` Kata Kasar Terdeteksi \`\`\`\n\nAdmin sudah Toxic, admin bebas Toxic apapun`})
if (isCreator) return emily.sendMessage(m.chat, {text: `\`\`\` Kata Kasar Terdeteksi \`\`\`\n\Owner telah Toxic, owner bebas Toxic apa pun`})
await emily.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
...
if (args[0].startsWith(`+62895372305081`)) return reply('Tidak bisa call ke nomor ini!')
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY EMILY MODS`);
});
}
} else reply(`Penggunaan spamsms nomor/reply pesan target*\nContoh spamsms +62895372305081`)
...
emily.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
}
break
//=================================================
...
emily.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: ` Title : ${media.title}\n File Size : ${media.filesizeF}\n Url : ${isUrl(text)}\n Ext : MP4\n Resolusi : ${args[1] || '360p'}` }, { quoted: m })
}
break
//=================================================
case 'getmusic': {
...
emily.sendMessage(m.chat, { video: { url: data.nowm }}, { quoted: m })
})
}
break
//=================================================
...
await loading ()
require('./lib/tiktok').Tiktok(q).then( data => {
emily.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
//=================================================
...
emily.sendMessage(from, { video: { url: data.result }, mimetype: 'video/mp4', caption : `silahkan ketik tovn atau to audio untuk merubah nya menjadi audio / vn`})
})
break
...
emily.sendMessage(from, { video: { url: data.result.link[data.result.link.length - 1].link }, mimetype: 'video/mp4' })
})
break
//=================================================//
case 'wm': {
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await emily.sendImageAsSticker(from, media, m, { packname: `${teks}`, author: `${botname}` })
await fs.unlinkSync(encmedia)
}
}
}
...
if (/video/.test(mime)) {
let media = await quoted.download()
let encmedia = await emily.sendVideoAsSticker(from, media, m, { packname: `${teks}`, author: `${botname}` })
await fs.unlinkSync(encmedia)
} else {
throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
}
...
case 'horrorblood':
case 'thunder':
if (args.length == 0) return reply(`Example: ${prefix + command} EMILY`)
await loading()
emily.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/textprome/${command}?apikey=${apikey}&text=${command}` } })
break
//=================================================//
case 'sound1':
case 'sound2':
...
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
 emilygans = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await emily.sendMessage(from, { audio: emilygans, mimetype: 'audio/mp4', ptt: true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6287737226143',
title: `EMILY`,
sourceUrl: `https://wa.me/62895372305081`, 
thumbnail: thumb
}
}})
break
...
emily.sendMessage(from, {image: { url: result }, caption: 'SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
case 'quotesimage':
await loading()
emily.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/random/${command}?apikey=${apikey}` } })
break
//=================================================//
case 'neko' :
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
...
emily.sendMessage(from, {image: {url:waifudd.data.url},caption:`Ah Sayang `},{ quoted:m }).catch(err => {
 return('Error!')
})
break
//=================================================//
...
emily.sendMessage(from, {image: {url:waifudd.data.url},caption:`Ahh Sayang `}, { quoted:m }).catch(err => {
 return('Error!')
})
break
//=================================================//
...
.then(({data}) => {
emily.sendImage(from, data.url, 'Success Coy', m)
})
break
//=================================================//
case 'fajar':
...
teks += ""
emily.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted:m })
})
break
//=================================================//
case 'tribun':
...
teks += `Source: ${reis}`
teks += ""
emily.sendMessage(m.chat, { image : { url : reis }, caption: teks }, { quoted:m })
break
//=================================================
case 'faktaunik':
case 'katabijak':
...
emily.sendMessage(from, { audio: { url: `https://api.lolhuman.xyz/api/quran/audio/${args[0]}?apikey=${apikey}` }, mimetype: 'audio/mp4' })
break
//=================================================
case 'asmaulhusna':
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
...
if (/image/.test(mime)) {
m.reply('*Sedang Loading...*')
mee = await emily.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(mee)
kaytid = await getBuffer(`https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`)
emily.sendImageAsSticker(m.chat, kaytid, m, { packname: global.packname, author: global.author })
}
break
//=================================================
...
let media = await emily.downloadAndSaveMediaMessage(quoted)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) throw err
let buffer = fs.readFileSync(ran)
emily.sendMessage(from, { image: buffer }, {quoted:m})
fs.unlinkSync(ran)
})
}
break
...
await emily.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, {quoted:m})
...
let media = await emily.downloadMediaMessage(quoted)
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
emily.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${emily.user.name}.mp3`}, { quoted : m })
}
break
//=================================================//
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
emily.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
}
break
//=================================================//
...
emily.sendMessage(from, {audio: audio, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/62895372305081',
title: `EMILY`,
sourceUrl: `https://wa.me/62895372305081`, 
thumbnail: thumb
}
...
let media = await emily.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await emily.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, {quoted:m})
await fs.unlinkSync(media)
}
break
//=================================================//
...
emily.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', caption:` Ah Sayang ` })
})
break
//=================================================//
case 'asupan2':
...
teks = "*Darkjokes*"
emily.sendMessage(m.chat, { image : { url : ress }, caption: teks }, { quoted:m })
break
//=================================================//
case 'emojimix': { 
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
...
let encmedia = await emily.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
await loading()
 ...
 emily.sendText(from, ` *Mimpi :* ${anu.message.mimpi}\n *Arti :* ${anu.message.arti}\n *Solusi :* ${anu.message.solusi}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
 if (!text) throw `Example : ${prefix + command} EMILY, 7, 7, 2005, Putri, 16, 11, 2004`
 let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
 let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Nama Anda :* ${anu.message.nama_anda.nama}\n *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n *Hasil :* ${anu.message.result}\n *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'artinama': {
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
 if (!text) throw `Example : ${prefix + command} EMILY Hw`
 let anu = await primbon.arti_nama(text)
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Nama :* ${anu.message.nama}\n *Arti :* ${anu.message.arti}\n *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
 if (!text) throw `Example : ${prefix + command} EMILY, 7, 7, 2005`
...
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
 if (!text) throw `Example : ${prefix + command} EMILY|Putri`
 let [nama1, nama2] = text.split`|`
 let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
 if (anu.status == false) return m.reply(anu.message)
 emily.sendImage(from,  anu.message.gambar, ` *Nama Anda :* ${anu.message.nama_anda}\n *Nama Pasangan :* ${anu.message.nama_pasangan}\n *Sisi Positif :* ${anu.message.sisi_positif}\n *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Tanggal Pernikahan :* ${anu.message.tanggal}\n *karakteristik :* ${anu.message.karakteristik}`, m)
}
break
//=================================================//
case 'sifatusaha': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Lahir :* ${anu.message.hari_lahir}\n *Usaha :* ${anu.message.usaha}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Analisa :* ${anu.message.analisa}\n *Angka Akar :* ${anu.message.angka_akar}\n *Sifat :* ${anu.message.sifat}\n *Elemen :* ${anu.message.elemen}\n *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendImage(from, anu.message.image, ` *Lahir :* ${anu.message.tgl_lahir}\n *Simbol Tarot :* ${anu.message.simbol_tarot}\n *Arti :* ${anu.message.arti}\n *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'fengshui': {
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
 if (!text) throw `Example : ${prefix + command} EMILY, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Lahir :* ${anu.message.tgl_lahir}\n *Kala Tinantang :* ${anu.message.kala_tinantang}\n *Info :* ${anu.message.info}\n *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Hari Lahir :* ${anu.message.hari_lahir}\n *Tanggal Lahir :* ${anu.message.tgl_lahir}\n *Hari Naas :* ${anu.message.hari_naas}\n *Info :* ${anu.message.catatan}\n *Catatan :* ${anu.message.info}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
await loading()
 if (!text) throw `Example : ${prefix + command} EMILY, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Tanggal :* ${anu.message.tanggal}\n *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n *Watak Hari :* ${anu.message.watak_hari}\n *Naga Hari :* ${anu.message.naga_hari}\n *Jam Baik :* ${anu.message.jam_baik}\n *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Tanggal :* ${anu.message.tgl_memancing}\n *Hasil :* ${anu.message.result}\n *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'masasubur': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Hasil :* ${anu.message.result}\n *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 emily.sendText(from, ` *Hasil :* ${anu.message}`, m)
}
break
//=================================================//
case 'setcmd': {
...
await loading()
let teks = `list cmd`
emily.sendText(from, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
break
//=================================================//
case 'addpdf':{
...
let delb = await emily.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
...
teksoooo = `\n\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf EMILY + sambil reply pesan target* \n\n Contoh 2 : yopdf EMILY`
m.reply(teksoooo)
}
break
//=================================================//
...
let teks = `${text}`
{
emily.sendMessage(from, { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
emily.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
teksooooo = `\n\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip EMILY + sambil reply pesan target* \n\n Contoh 2 : yozip EMILY`
m.reply(teksooooo)
}
break
//=================================================//
...
let teks = `${text}`
{
emily.sendMessage(from, { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
emily.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
teksoooooo = `\n\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk EMILY + sambil reply pesan target* \n\n Contoh 2 : yoapk EMILY`
m.reply(teksoooooo)
}
break
//=================================================//
...
let teks = `${text}`
{
emily.sendMessage(from, { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
emily.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
await loading()
 ...
 emily.copyNForward(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", msgs[text.toLowerCase()], true)
...
await loading()
 ...
 let msgs = global.db.data.database
 if (!(text.toLowerCase() in msgs)) throw `'${text}' tidak terdaftar di list pesan`
 emily.copyNForward(from, msgs[text.toLowerCase()], true)
}
break
//=================================================//
case 'google': {
...
emily.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, {quoted:m})
emily.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, {quoted:m})
}
break
//=================================================//
case 'coffe': case 'kopi': {
await loading()
emily.sendMessage(from, {image: { url: 'https://coffee.alexflipnote.dev/random' },
...
await loading()
if (qtod === "true") {
namenye = await emily.getName(m.quoted.sender)
m.reply(namenye)
} else if (qtod === "false") {
emily.sendMessage(from, {text:"Reply orangnya"}, {quoted:m})
}
}
break
//=================================================//
...
if (qtod === "true") {
try {
pporg = await emily.profilePictureUrl(m.quoted.sender, 'image')
} catch {
pporg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
emily.sendMessage(from, { image : { url : pporg }, caption:`Done` }, {quoted:m})
} else if (qtod === "false") {
try {
pporgs = await emily.profilePictureUrl(from, 'image')
} catch {
pporgs = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
emily.sendMessage(from, { image : { url : pporgs }, caption:`Done` }, {quoted:m})
}
}
break
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await emily.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'unblock': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await emily.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'stalktiktok':
...
emily.sendMessage(from, { image: { url: data.result.user_picture }, caption })
})
break
//=================================================//
//=================================================//
...
emily.sendMessage(from, { image: { url: data.result.map }, caption })
break
//=================================================
case 'lirik':
...
caption += `Story :\n${data.result.story}\n`
emily.sendMessage(from, { image: { url: data.result.thumbnail }, caption })
break
//=================================================
case 'cuaca':
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
...
emily.sendMessage(from, { location: { degreesLatitude: data.result.latitude, degreesLongitude: data.result.longitude } })
reply(textppp)
break
//=================================================
case 'afk': {
...
if (m.quoted && m.quoted.mtype === 'conversation' && !text) _m = emily.sendMessage('status@broadcast', {
text: m.quoted.text,
}, {
...
if (!m.quoted && text) _m = emily.sendMessage('status@broadcast', {
text,
}, {
backgroundColor: '#FF000000',
font: 3,
...
const media = await emily.downloadAndSaveMediaMessage(quoted)
emily.sendMessage('status@broadcast', { image: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
const media = await emily.downloadAndSaveMediaMessage(quoted)
emily.sendMessage('status@broadcast', { video: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
emily.sendMessage('status@broadcast', {
text: `${text}`
}, {
backgroundColor: '#FF000000',
font: 3,
...
emily.sendMessage('status@broadcast', {audio: huy, mimetype: 'audio/mp4', ptt:true},{
backgroundColor: '#FF000000',
statusJidList: pengguna
});
}
...
emily.sendMessage('status@broadcast', {audio: buu, mimetype:'audio/mp4', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/62895372305081',
title: `RLP27`,
sourceUrl: `https://wa.me/62895372305081`, 
...
if (!isCreator) return m.reply('*Khusus Premium*')
await loading ()
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 62895372305081@s.whatsapp.net`)
...
emily.sendMessage(from, { text: teksoooo.trim() }, 'extendedTextMessage', { quoted:m, contextInfo: { "mentionedJid": pengguna } })
break
//=================================================
case "buatswptv":
{
...
emily.relayMessage('status@broadcast', ptv.message, {
statusJidList: pengguna
})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
...
emily.relayMessage(from, ptv.message, { messageId: ptv.key.id })
}
}
break
//=================================================
...
if (!/webp/.test(mime)) throw `Balas sticker dengan caption *${prefix + command}*`
const media = await emily.downloadAndSaveMediaMessage(quoted)
emily.sendMessage('status@broadcast', { sticker: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case 'family100': {
 ...
 id: 'family100'+from,
 pesan: await emily.sendText(from, hasil, m),
 ...random,
...
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
 ...
 let msg = await emily.sendMessage(from, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, {quoted:m})
 emily.sendText(from, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
 tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
 })
 await sleep(3000)
 if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
 console.log("Jawaban: " + result.jawaban)
 emily.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/297a0ffd35ca495c710b0.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:m}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 emily.sendImage(from, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 emily.sendText(from, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 emily.sendText(from, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 emily.sendText(from, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
...
if (isBan) return m.reply('*Kamu Kena Banned Silahkan Hubbungin Owner*')
 ...
 emily.sendText(from, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
this.suit[id] = {
chat: await emily.sendText(from, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) emily.sendText(from, `_Waktu suit habis_`, m)
delete this.suit[id]
...
emily.relayMessage(from, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
}
}
break
 //=================================================
...
const text = `${teks}`
const username = await emily.getName(m.quoted ? m.quoted.sender : m.sender)
const avatar = await emily.profilePictureUrl( m.quoted ? m.quoted.sender : m.sender,"image").catch(() =>`https://i0.wp.com/telegra.ph/file/134ccbbd0dfc434a910ab.png`)
...
emily.sendMessage(from,{image: buffer},{quoted : hw})
})
}
break
//=================================================//
...
.then(async (res) => {
const buffer = Buffer.from(res.data.result.image, "base64");
let encmedia = await emily.sendImageAsSticker(m.chat, buffer, m, { packname: global.packname, 
...
emily.sendMessage(m.chat, { image: proses, caption:'Sukses'})
}catch (error) {
m.reply('erorr')
}}
break
...
if (!isCreator) return m.reply(`*khusus Premium*`)
let { UploadFileUgu, webp2mp4File, TelegraPh } = require('./lib/uploader')
var media = await emily.downloadAndSaveMediaMessage(quoted)
...
emily.sendMessage(from, {image: {url: proses}, caption: 'Done!'}, {quoted : hw})
break
//=================================================
default:
if (budy.startsWith('=>')) {
...
emily.copyNForward(from, msgs[budy.toLowerCase()], true)}}
} catch (err) {
